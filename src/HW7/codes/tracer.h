...
public:
	...
	int rayHalfspaceIntersect(raytraceData::ray* r, raytraceData::halfspace* s, float* t);
	void findSphereNormal(raytraceData::sphere* s, raytraceData::point* p, raytraceData::vector* n);
	void findHalfspaceNormal(raytraceData::halfspace* s, raytraceData::point* p, raytraceData::vector* n);
